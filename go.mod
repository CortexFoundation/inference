...
require (
	github.com/CortexFoundation/CortexTheseus v1.10.35-0.20221114234226-515e5884878d
	github.com/CortexFoundation/cvm-runtime v0.0.0-20211224071955-b758984585d7
